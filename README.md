# astrocade-project
Instruction:
After cloned this repo to your local folder, run "npm i" to install all the required packages and dependencies. Then run "npm run dev" to run the vite dev server. And open the localhost link provided in the terminal (e.g. http://127.0.0.1:5174/) and explore the application on your web.
